...
class Payloads:
    ...
    def get_wifi_settings_body(self):
        payload = {
            ...
            "event_name": "MESSAGE/6528f82903c4b8f0d296d1ea",
            "data": "{\"event\": \"WIFI_NETWORK_CONFIG\", \"udid\": \"56AI010100000015\",\"timestamp\": \"1682077731\", \"id\": \"63ce55886b9ce300f9831f6b\", \"request_id\":\"87e5d0e7-6e10-4f27-877a-1b9d1a19dd2d\", \"state\": \"ENABLE\",\"ssid\": \"56Secure3\",\"password\":  \"56Secure@123$\",\"security\": \"WPA2\"}"
        }
        return payload
